...
export interface IconBootstrapProps extends SvgIconProps {}

export const IconBootstrap: React.FC<IconBootstrapProps> = ({ ...props }) => {
    return (
        <SvgIcon viewBox="0 0 256 256" fill="none" sx={{ fill: 'none' }} {...props}>
            <rect width="256" height="256" fill="url(#paint0_linear_158_100)" rx="20" />
